...
описание_ru: «Адвокат дьявола» — структурно атакует идеи, планы и решения: red team, pre-mortem, аудит допущений и доказательств.
когда_использовать_ru: Перед запуском важного решения, продукта или гипотезы — когда хочешь, чтобы кто-то жёстко поспорил, нашёл дыры и проверил твои аргументы на прочность.
license: MIT
metadata:
