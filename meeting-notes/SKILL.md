...
описание_ru: Превращает транскрипт встречи или сырые заметки в структурированный список action items с ответственными, дедлайнами и следующими шагами.
когда_использовать_ru: После созвона/совещания — когда нужно быстро вытащить «кто что делает к когда», не разбирая час расшифровки руками.
