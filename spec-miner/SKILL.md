...
описание_ru: Реверс-инжиниринг кодовой базы — строит карту зависимостей, документирует API из исходников и выявляет скрытую бизнес-логику в проектах без документации.
когда_использовать_ru: Когда достался легаси-проект, наследие без документации или нужно быстро разобраться, как устроена незнакомая система, чтобы безопасно её менять.
license: MIT
