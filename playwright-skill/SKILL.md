...
описание_ru: Проверенные паттерны Playwright для написания, отладки и масштабирования стабильных тестов — E2E, API, компонентные, визуальные, accessibility, security, плюс CI/CD и Page Objects.
когда_использовать_ru: Когда пишешь или чинишь автотесты на Playwright (TS/JS), мигрируешь с Cypress/Selenium или хочешь выстроить надёжный test suite в CI.
license: MIT
metadata:
  author: testdino.com
  version: "2.2.0"
