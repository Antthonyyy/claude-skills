...
описание_ru: Безопасная реализация аутентификации, авторизации и защиты от OWASP Top 10 — bcrypt/argon2, параметризованные SQL-запросы, CORS/CSP, валидация через Zod, JWT-токены.
когда_использовать_ru: Когда пишешь систему логина/прав доступа, защищаешь ввод пользователя или закрываешь типовые уязвимости (XSS, CSRF, SQLi) перед выходом в прод.
license: MIT
metadata:
