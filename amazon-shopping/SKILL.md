...
описание_ru: Покупки на Amazon через реальный браузер — поиск товаров, чтение отзывов, сравнение вариантов и оформление заказа с подтверждением от пользователя.
когда_использовать_ru: Когда надо что-то купить на Amazon, подобрать товар по требованиям, сравнить модели по цене и отзывам или просто заказать вещь онлайн.
