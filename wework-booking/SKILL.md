...
описание_ru: Автоматически бронирует hot-desk слоты в WeWork на ближайшие 30 дней — не нужно каждый день заходить в приложение.
когда_использовать_ru: Когда нужно зарезервировать место в коворкинге WeWork сразу на месяц вперёд или просто закрыть бронь на ближайшие дни одной командой.
...
python3 "C:/Users/gnilo/Desktop/Free Claude Code Skills/execution/wework_bulk_booking.py" --start 2026-03-01 --days 30

# Actually book them
python3 "C:/Users/gnilo/Desktop/Free Claude Code Skills/execution/wework_bulk_booking.py" --start 2026-03-01 --days 30 --live

# Weekdays only
python3 "C:/Users/gnilo/Desktop/Free Claude Code Skills/execution/wework_bulk_booking.py" --start 2026-03-01 --days 30 --live --weekdays-only

# Resume an interrupted run
python3 "C:/Users/gnilo/Desktop/Free Claude Code Skills/execution/wework_bulk_booking.py" --start 2026-03-01 --days 30 --live --resume
```
