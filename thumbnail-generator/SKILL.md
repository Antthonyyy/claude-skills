...
описание_ru: Генерация YouTube-обложек — берёт готовый шаблон, подставляет твоё лицо через face-swap и докручивает цвета, текст и стиль.
когда_использовать_ru: Когда нужно быстро сделать превью для видео или повторить удачную обложку другого блогера в своём оформлении.
...
python3 "C:/Users/gnilo/Desktop/Free Claude Code Skills/execution/recreate_thumbnails.py" --source "https://i.ytimg.com/vi/VIDEO_ID/maxresdefault.jpg" --no-match --refs 1 --variations 1

# From local file
python3 "C:/Users/gnilo/Desktop/Free Claude Code Skills/execution/recreate_thumbnails.py" --source "path/to/thumbnail.jpg" --no-match --refs 1 --variations 1
```
...
python3 "C:/Users/gnilo/Desktop/Free Claude Code Skills/execution/recreate_thumbnails.py" --source "URL" --no-match --refs 1 --variations 1 \
...
```bash
python3 "C:/Users/gnilo/Desktop/Free Claude Code Skills/execution/recreate_thumbnails.py" --edit ".tmp/thumbnails/20260228/115127_1.png" \
