...
описание_ru: По краткому описанию собирает «киношный», высококачественный лендинг и сразу публикует его в продакшен на Netlify.
когда_использовать_ru: Когда нужно быстро сделать сайт-визитку, лендинг под клиента или promo-страницу и выложить её живой по ссылке без ручного деплоя.
