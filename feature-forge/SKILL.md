...
описание_ru: Структурированный сбор требований к фиче — выдаёт спецификацию, user stories, требования в формате EARS, критерии приёмки и чек-лист по реализации.
когда_использовать_ru: Когда нужно описать новую фичу перед разработкой, собрать PRD, превратить идею в чёткие требования и acceptance criteria.
license: MIT
metadata:
