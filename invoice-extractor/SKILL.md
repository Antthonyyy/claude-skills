...
описание_ru: Достаёт из PDF-инвойсов структурированный JSON — поставщик, сумма, дата, позиции, налоги — готовый к загрузке в учётную систему.
когда_использовать_ru: Когда есть пачка инвойсов или чеков в PDF и нужно вытащить из них данные для бухгалтерии, отчётности или импорта в CRM/Excel.
...
```bash
python3 "C:/Users/gnilo/Desktop/Free Claude Code Skills/execution/extract_invoice.py" "$ARGUMENTS"
```
