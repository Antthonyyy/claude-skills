...
описание_ru: Проектирует и собирает продакшн-RAG: чанкование документов, эмбеддинги, векторная БД, гибридный поиск, реранкинг и оценка качества ретривала.
когда_использовать_ru: Когда строишь чат-бота/ассистента по своей базе знаний, делаешь семантический поиск или собираешь LLM-приложение поверх своих документов.
license: MIT
metadata:
